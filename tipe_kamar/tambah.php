...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Pastikan harga adalah integer, gunakan filter_var untuk validasi
    ...
    if ($harga === false || $harga < 0) {
        ...
        // Asumsi struktur database Anda sudah memiliki kolom 'nama_tipe', 'fasilitas', 'harga'
        $stmt = $conn->prepare("INSERT INTO tipe_kamar (nama_tipe, fasilitas, harga) VALUES (?, ?, ?)");
        $stmt->bind_param('ssi', $nama, $fasilitas, $harga);
